...
#define GOSUBS                       93        /* 0x5d same as below but also
                                                  save */
#define GOSUBS_tb                      186     /*      0x0ba */
#define GOSUBS_t8                      187     /*      0x0bb */
#define GOSUBS_tb_pb                      372  /*      0x174 */
#define GOSUBS_tb_p8                      373  /*      0x175 */
#define GOSUBS_t8_pb                      374  /*      0x176 */
#define GOSUBS_t8_p8                      375  /*      0x177 */

#define GOSUBG                       93        /* 0x5d same as below but also
                                                  save */
#define GOSUBG_tb                      186     /*      0x0ba */
#define GOSUBG_t8                      187     /*      0x0bb */
#define GOSUBG_tb_pb                      372  /*      0x174 */
#define GOSUBG_tb_p8                      373  /*      0x175 */
#define GOSUBG_t8_pb                      374  /*      0x176 */
#define GOSUBG_t8_p8                      375  /*      0x177 */
...
#define GOSUBSS                      95        /* 0x5f same as GOSUBS but also
                                                  clear before the call */
#define GOSUBSS_tb                     190     /*      0x0be */
#define GOSUBSS_t8                     191     /*      0x0bf */
#define GOSUBSS_tb_pb                     380  /*      0x17c */
#define GOSUBSS_tb_p8                     381  /*      0x17d */
#define GOSUBSS_t8_pb                     382  /*      0x17e */
#define GOSUBSS_t8_p8                     383  /*      0x17f */

#define GOSUBKS                      96        /* 0x60 same as GOSUBS but also
                                                  keeps in current context */
#define GOSUBKS_tb                     192     /*      0x0c0 */
#define GOSUBKS_t8                     193     /*      0x0c1 */
#define GOSUBKS_tb_pb                     384  /*      0x180 */
#define GOSUBKS_tb_p8                     385  /*      0x181 */
#define GOSUBKS_t8_pb                     386  /*      0x182 */
#define GOSUBKS_t8_p8                     387  /*      0x183 */

#define GOSUBK                       97        /* 0x61 same as GOSUB but also
                                                  keeps */
#define GOSUBK_tb                      194     /*      0x0c2 */
#define GOSUBK_t8                      195     /*      0x0c3 */
#define GOSUBK_tb_pb                      388  /*      0x184 */
#define GOSUBK_tb_p8                      389  /*      0x185 */
#define GOSUBK_t8_pb                      390  /*      0x186 */
#define GOSUBK_t8_p8                      391  /*      0x187 */

#define GROUPPN                      98        /* 0x62 Whether the group
                                                  matched. */
#define GROUPPN_tb                     196     /*      0x0c4 */
#define GROUPPN_t8                     197     /*      0x0c5 */
#define GROUPPN_tb_pb                     392  /*      0x188 */
#define GROUPPN_tb_p8                     393  /*      0x189 */
#define GROUPPN_t8_pb                     394  /*      0x18a */
#define GROUPPN_t8_p8                     395  /*      0x18b */

#define INSUBP                       99        /* 0x63 Whether we are in a
                                                  specific recurse. */
#define INSUBP_tb                      198     /*      0x0c6 */
#define INSUBP_t8                      199     /*      0x0c7 */
#define INSUBP_tb_pb                      396  /*      0x18c */
#define INSUBP_tb_p8                      397  /*      0x18d */
#define INSUBP_t8_pb                      398  /*      0x18e */
#define INSUBP_t8_p8                      399  /*      0x18f */

#define DEFINEP                     100        /* 0x64 Never execute directly.
                                               */
#define DEFINEP_tb                     200     /*      0x0c8 */
#define DEFINEP_t8                     201     /*      0x0c9 */
#define DEFINEP_tb_pb                     400  /*      0x190 */
#define DEFINEP_tb_p8                     401  /*      0x191 */
#define DEFINEP_t8_pb                     402  /*      0x192 */
#define DEFINEP_t8_p8                     403  /*      0x193 */

#define ENDLIKE                     101        /* 0x65 Used only for the type
                                                  field of verbs */
#define ENDLIKE_tb                     202     /*      0x0ca */
#define ENDLIKE_t8                     203     /*      0x0cb */
#define ENDLIKE_tb_pb                     404  /*      0x194 */
#define ENDLIKE_tb_p8                     405  /*      0x195 */
#define ENDLIKE_t8_pb                     406  /*      0x196 */
#define ENDLIKE_t8_p8                     407  /*      0x197 */

#define OPFAIL                      102        /* 0x66 Same as (?!), but with
                                                  verb arg */
#define OPFAIL_tb                      204     /*      0x0cc */
#define OPFAIL_t8                      205     /*      0x0cd */
#define OPFAIL_tb_pb                      408  /*      0x198 */
#define OPFAIL_tb_p8                      409  /*      0x199 */
#define OPFAIL_t8_pb                      410  /*      0x19a */
#define OPFAIL_t8_p8                      411  /*      0x19b */

#define ACCEPT                      103        /* 0x67 Accepts the current
                                                  matched string, with verbar
                                               */
#define ACCEPT_tb                      206     /*      0x0ce */
#define ACCEPT_t8                      207     /*      0x0cf */
#define ACCEPT_tb_pb                      412  /*      0x19c */
#define ACCEPT_tb_p8                      413  /*      0x19d */
#define ACCEPT_t8_pb                      414  /*      0x19e */
#define ACCEPT_t8_p8                      415  /*      0x19f */

#define VERB                        104        /* 0x68 Used only for the type
                                                  field of verbs */
#define VERB_tb                        208     /*      0x0d0 */
#define VERB_t8                        209     /*      0x0d1 */
#define VERB_tb_pb                        416  /*      0x1a0 */
#define VERB_tb_p8                        417  /*      0x1a1 */
#define VERB_t8_pb                        418  /*      0x1a2 */
#define VERB_t8_p8                        419  /*      0x1a3 */

#define PRUNE                       105        /* 0x69 Pattern fails at this
                                                  startpoint if
                                                  no-backtracking through this
                                               */
#define PRUNE_tb                       210     /*      0x0d2 */
#define PRUNE_t8                       211     /*      0x0d3 */
#define PRUNE_tb_pb                       420  /*      0x1a4 */
#define PRUNE_tb_p8                       421  /*      0x1a5 */
#define PRUNE_t8_pb                       422  /*      0x1a6 */
#define PRUNE_t8_p8                       423  /*      0x1a7 */

#define MARKPOINT                   106        /* 0x6a Push the current
                                                  location for rollback by
                                                  cut. */
#define MARKPOINT_tb                   212     /*      0x0d4 */
#define MARKPOINT_t8                   213     /*      0x0d5 */
#define MARKPOINT_tb_pb                   424  /*      0x1a8 */
#define MARKPOINT_tb_p8                   425  /*      0x1a9 */
#define MARKPOINT_t8_pb                   426  /*      0x1aa */
#define MARKPOINT_t8_p8                   427  /*      0x1ab */

#define SKIP                        107        /* 0x6b On failure skip forward
                                                  (to the mark) before
                                                  retrying */
#define SKIP_tb                        214     /*      0x0d6 */
#define SKIP_t8                        215     /*      0x0d7 */
#define SKIP_tb_pb                        428  /*      0x1ac */
#define SKIP_tb_p8                        429  /*      0x1ad */
#define SKIP_t8_pb                        430  /*      0x1ae */
#define SKIP_t8_p8                        431  /*      0x1af */

#define COMMIT                      108        /* 0x6c Pattern fails outright
                                                  if backtracking through this
                                               */
#define COMMIT_tb                      216     /*      0x0d8 */
#define COMMIT_t8                      217     /*      0x0d9 */
#define COMMIT_tb_pb                      432  /*      0x1b0 */
#define COMMIT_tb_p8                      433  /*      0x1b1 */
#define COMMIT_t8_pb                      434  /*      0x1b2 */
#define COMMIT_t8_p8                      435  /*      0x1b3 */

#define CUTGROUP                    109        /* 0x6d On failure go to the
                                                  next alternation in the
                                                  group */
#define CUTGROUP_tb                    218     /*      0x0da */
#define CUTGROUP_t8                    219     /*      0x0db */
#define CUTGROUP_tb_pb                    436  /*      0x1b4 */
#define CUTGROUP_tb_p8                    437  /*      0x1b5 */
#define CUTGROUP_t8_pb                    438  /*      0x1b6 */
#define CUTGROUP_t8_p8                    439  /*      0x1b7 */

#define KEEPS                       110        /* 0x6e $& begins here. */
#define KEEPS_tb                       220     /*      0x0dc */
#define KEEPS_t8                       221     /*      0x0dd */
#define KEEPS_tb_pb                       440  /*      0x1b8 */
#define KEEPS_tb_p8                       441  /*      0x1b9 */
#define KEEPS_t8_pb                       442  /*      0x1ba */
#define KEEPS_t8_p8                       443  /*      0x1bb */

#define OPTIMIZED                   111        /* 0x6f Placeholder for dump.
                                               */
#define OPTIMIZED_tb                   222     /*      0x0de */
#define OPTIMIZED_t8                   223     /*      0x0df */
#define OPTIMIZED_tb_pb                   444  /*      0x1bc */
#define OPTIMIZED_tb_p8                   445  /*      0x1bd */
#define OPTIMIZED_t8_pb                   446  /*      0x1be */
#define OPTIMIZED_t8_p8                   447  /*      0x1bf */
...
#define EVAL_postponed_AB           118        /* 0x76 state for EVAL */
#define EVAL_postponed_AB_tb           236     /*      0x0ec */
#define EVAL_postponed_AB_t8           237     /*      0x0ed */
#define EVAL_postponed_AB_tb_pb           472  /*      0x1d8 */
#define EVAL_postponed_AB_tb_p8           473  /*      0x1d9 */
#define EVAL_postponed_AB_t8_pb           474  /*      0x1da */
#define EVAL_postponed_AB_t8_p8           475  /*      0x1db */

#define EVAL_postponed_AB_fail      119        /* 0x77 state for EVAL */
#define EVAL_postponed_AB_fail_tb      238     /*      0x0ee */
#define EVAL_postponed_AB_fail_t8      239     /*      0x0ef */
#define EVAL_postponed_AB_fail_tb_pb      476  /*      0x1dc */
#define EVAL_postponed_AB_fail_tb_p8      477  /*      0x1dd */
#define EVAL_postponed_AB_fail_t8_pb      478  /*      0x1de */
#define EVAL_postponed_AB_fail_t8_p8      479  /*      0x1df */
...
static const U8 regarglen[] = {
	...
	EXTRA_SIZE(struct regnode_2L),       	/* GOSUBS       */
	EXTRA_SIZE(struct regnode_2L),       	/* GOSUB        */
	EXTRA_SIZE(struct regnode_2L),       	/* GOSUBSS      */
	EXTRA_SIZE(struct regnode_2L),       	/* GOSUBKS      */
	EXTRA_SIZE(struct regnode_2L),       	/* GOSUBK       */
...
#else
EXTCONST U8 PL_varies_bitmask[] = {
    0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x00, 0xE0, 0x0F, 0xFF, 0xCB, 0x00, 0x00, 0x00, 0x00
};
#endif /* DOINIT */
...
#else
EXTCONST U8 PL_simple_bitmask[] = {
    0x00, 0x00, 0xFF, 0xFF, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02
};
#endif /* DOINIT */
