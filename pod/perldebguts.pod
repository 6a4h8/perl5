...
=for regcomp.pl begin
 ...
 # Regex Subroutines
 GOSUBS           num/ofs 2L same as below but also save
 GOSUB            num/ofs 2L recurse to paren arg1 at (signed) ofs arg2
 GOSUBSS          num/ofs 2L same as GOSUBS but also clear before the
                             call
 GOSUBKS          num/ofs 2L same as GOSUBS but also keeps in current
                             context
 GOSUBK           num/ofs 2L same as GOSUB but also keeps
